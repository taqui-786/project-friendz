  ...
  return (
    ...
    <div className="bg-white">
      <div className="p-2 table-cell">
        <Image src={image} alt='user' height={50} width={50} loading='eager' priority className='relative m-0 p-1 rounded-full w-full h-auto min-w-[50px] max-h-[50px] border border-[#cecece]' />
      </div>
